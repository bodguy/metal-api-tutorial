...
int init() {
  ...
  compileOpts.languageVersion = MTLLanguageVersion1_1;
  ...
  g_vertexBuffer = [g_mtlDevice newBufferWithBytes:quad length:sizeof(quad) options:MTLResourceOptionCPUCacheModeDefault];
